<%@ Page Title ="Link a Flow Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FlowInfoLink.aspx.cs" Inherits="BillPaymentGroupAssignment.FlowInfoLink" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="jumbotron text-center">
        <p class ="h1">Link Your Flow Acount</p>
        <h3 class ="lead">Here you can enter your flow account information for linking</h3>
    </div>
