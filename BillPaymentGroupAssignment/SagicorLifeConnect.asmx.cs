...
{
    /// <summary>
    /// Summary description for SagicorLifeConnect
    /// </summary>
    [WebService(Namespace = "http://Sagicor.com/webservices")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    // To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
    // [System.Web.Script.Services.ScriptService]
    public class SagicorLifeConnect : System.Web.Services.WebService
    {
        ...
        public bool CheckSagicor(string userAccNum, string userAccEmail, string userAccPhoneNum)
        {
            ...
            cmd.CommandText = "select * from SagicorLifeAccounts where AccountNumber = '" + userAccNum + "'";
        ...
        [WebMethod]
        public List<string> GetSagicorInfo(string accNum)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from SagicorLifeAccounts where AccountNumber = '" + accNum + "'";
            SqlDataReader rdr = cmd.ExecuteReader();
            if (!rdr.Read())
            {
                return null;
